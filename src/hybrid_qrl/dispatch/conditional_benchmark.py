"""Conditional quantum-assisted advantage study execution.
...
from ..utilities.reports.conditional import render_conditional_report
...
def run_conditional_study(
    ...
    ResultWriter(json_trailing_newline=False).artifacts(
        ...
        payload=results,
        render_report=render_conditional_report,
    )
    return results
