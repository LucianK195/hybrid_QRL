...
def build_report(results: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"{rollout_means['rydberg_surrogate']:.3f}. Equal-latency compliance was "
        f"{compliance:.1%}; non-compliant trials remain identifiable in the JSON. "
    ...
    lines.extend(
        [
            ...
            "diversity, and feasibility at competitive end-to-end latency as n and "
            "noise grow. Any latency row exceeding 105% of the target is marked "
            "non-compliant in the raw JSON and must not support an "
            "equal-latency claim.",
            "",
